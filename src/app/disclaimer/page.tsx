            ...
            <div className="lg:col-span-9 bg-white border border-gray-100 rounded-3xl shadow-sm p-6 sm:p-10 md:p-12 space-y-12">
              ...
              <div className="bg-linear-to-br from-green-50/70 to-emerald-50/30 border border-green-100 rounded-2xl p-6 md:p-8 shadow-sm">
                <h3 className="text-lg font-bold text-green-900 flex items-center gap-2 mb-3">
                  ðŸ’¡ Disclaimer Highlights (TL;DR)
                </h3>
              ...
              <div className="space-y-12 text-gray-700 leading-relaxed text-[16px]">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-amber-50/50 border-l-4 border-amber-500 rounded-r-xl p-4 my-6">
                      <p className="text-amber-800 text-xs leading-relaxed font-medium">
                        <strong>Official Trademark Clarification:</strong> WhatsAppâ„¢, Instagramâ„¢, Facebookâ„¢ are registered trademarks of Meta Platforms, Inc. Telegramâ„¢ is a registered trademark of Telegram FZ-LLC. Discordâ„¢ is a registered trademark of Discord Inc. Use of these names on our Platform does not imply endorsement or official affiliation.
                      </p>
                    </div>
                  </div>
                </section>
                ...
                <section id="warranties" className="scroll-mt-24 border-b border-gray-100 pb-10">
                  ...
                  <div className="space-y-4">
                    <p className="italic text-gray-600">
                      Groupsora provides its directory on an â€œAS ISâ€ and â€œAS AVAILABLEâ€ basis without warranties of any kind, whether express or implied.
                    </p>
                    <p>
                ...
                <section id="copyright" className="scroll-mt-24 pb-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <p>
                      Please include the exact URL of the listing and evidence of ownership in your message. We process all legitimate removal requests within 48â€“72 hours.
                    </p>
                    <Link
                      href="/contact"
