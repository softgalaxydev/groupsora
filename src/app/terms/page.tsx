              ...
              <div className="space-y-12 text-gray-700 leading-relaxed text-[16px]">
                ...
                <section id="intro" className="scroll-mt-24 border-b border-gray-100 pb-10">
                  ...
                  <div className="space-y-4">
                    <p>
                      Welcome to Groupsora (â€œwe,â€ â€œour,â€ or â€œthe Platformâ€). Groupsora is an independent online directory and search engine created to help users discover, browse, share, and join public social communities across platforms such as WhatsApp, Telegram, Instagram, and more.
                    </p>
                    <p>
                ...
                <section id="disclaimers" className="scroll-mt-24 border-b border-gray-100 pb-10">
                  ...
                  <div className="space-y-4">
                    <p className="italic text-gray-600">
                      All services, content, and features available on Groupsora are provided on an â€œAS ISâ€ and â€œAS AVAILABLEâ€ basis without any warranties of any kind, whether express or implied.
                    </p>
                    <p>
                ...
                <section id="moderation" className="scroll-mt-24 border-b border-gray-100 pb-10">
                  ...
                  <div className="space-y-4">
                    ...
                    <p>
                      If you are a copyright owner, a brand manager, or an admin of a group and wish to request the removal of a specific listing due to trademark violation, copyright infringement (DMCA), or privacy concerns, please contact us immediately. We process all legitimate takedown requests within 48â€“72 hours.
                    </p>
                  </div>
                </section>
